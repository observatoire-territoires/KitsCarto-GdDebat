...
mainfont: Chalet-LondonSixty.otf
sansfont: Chalet-NewYorkSixty.otf
header-includes:
- \usepackage{booktabs}
...
cat("\\backgroundsetup{
        ...
        angle=0,
        contents={%
          \\includegraphics[width=\\paperwidth,height=\\paperheight]{img/COUV_GD_2.jpg}
          }%
}")

cat(paste0("\\BgThispage
